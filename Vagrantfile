...
Vagrant::Config.run do |config|
  ...
  config.vm.host_name  = 'private-server-dev'

  # Provisioning OK!
  config.vm.box        = "ubuntu-121064"
  config.vm.box_url    = "https://dl.dropbox.com/u/10717540/vagrant/ubuntu-121064.box"

  # Provisioning PROBLEM (test-kitchen argument ;o):
#  config.vm.box        = 'opscode-ubuntu-12.04'
#  config.vm.box_url    = 'https://opscode-vm.s3.amazonaws.com/vagrant/boxes/opscode-ubuntu-12.04.box'

#  config.vm.host_name = "private-server-berkshelf"
...
#  config.ssh.timeout   = 120
  ...
  config.vm.provision :chef_solo do |chef|
     #TODO chef.cookbooks_path = ["site-cookbooks"]
#    chef.json = {
#      :mysql => {
